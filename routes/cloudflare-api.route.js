...
// List all zones
router.get("/list-zones", async (req, res) => {
  try {
...
// Delete Zone
router.delete("/delete-zone/:zoneId", async (req, res) => {
...
router.get("/check-zone-status/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/list-dns-records/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.post("/add-dns-record/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.delete("/delete-dns-record/:zoneId/:recordId", async (req, res) => {
...
router.put("/edit-dns-record/:zoneId/:recordId", async (req, res) => {
  const { zoneId, recordId } = req.params;
  const { type, name, content, priority } = req.body;
...
// Get SSL settings
router.get("/get-ssl-settings/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// Update SSL Settings
router.patch("/set-ssl-settings/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// Verify SSL Status
router.get("/verify-ssl-status/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/list-edge-certificates/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-opportunistic-encryption/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-opportunistic-encryption/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// Get TLS 1.3 setting
router.get("/get-tls-1-3/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-tls-1-3/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body;
...
// Brotli
router.get("/get-brotli-compression/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-brotli-compression/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// Early Hints
router.get("/get-early-hints/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-early-hints/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
// Rocket Loader
router.get("/get-rocket-loader/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-rocket-loader/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
// Auto Minify
router.get("/get-auto-minify/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-auto-minify/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-0rtt/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-0rtt/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
router.get("/get-http3/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-http3/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
// Get HTTP/2 Setting
router.get("/get-http2/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-http2/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
router.get("/get-http2-to-origin/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-http2-to-origin/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.post("/purge-all-cache/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.post("/purge-by-url/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-cache-level/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-cache-level/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-browser-cache-ttl/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-browser-cache-ttl/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-development-mode/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-development-mode/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/get-always-online/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-always-online/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: 1 (on), 0 (off)
...
router.get("/get-argo-tiered-caching/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/update-argo-tiered-caching/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
router.get("/get-image-resizing-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-image-resizing-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body; // Accepted values: "on" or "off"
...
// Get Polish Settings
router.get("/get-polish-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.patch("/change-polish-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body;
...
// Get webP setting
router.get("/get-webp-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// Change webP setting
router.patch("/change-webp-setting/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
  const { value } = req.body;
  try {
...
// List Page Rules
router.get("/list-page-rules/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
router.get("/page-rule-details/:zoneId/:identifier", async (req, res) => {
...
// Create a page rule
router.post("/create-page-rule/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// edit a page rule
router.patch("/edit-page-rule/:zoneId/:identifier", async (req, res) => {
  const { zoneId, identifier } = req.params;
  const { targets, actions, priority, status } = req.body;
...
// Delete a page rule
router.delete("/delete-page-rule/:zoneId/:identifier", async (req, res) => {
  const { zoneId, identifier } = req.params;
...
// Get APO
router.get("/get-apo-settings/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
...
// change apo setting
router.patch("/change-apo-settings/:zoneId", async (req, res) => {
  const { zoneId } = req.params;
